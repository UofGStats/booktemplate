...
![What people hear](resources/ForChX/yl1.png "What people hear"){#fig-yl-pie-heard fig-alt="Pie chart showing breakdown of what respondents heard. Main groups: 43.8% Laurel, 43.8% Yanny" fig-pos="H"}

![Gender demographics of survey respondents](resources/ForChX/yl2.png "Gender demographics of survey respondents"){#fig-yl-pie-gender fig-alt="Pie chart showing breakdown of respondents' genders. Main groups: 42.4% Male, 57.6 Female" fig-pos="H"}

![Age demographics of survey respondents](resources/ForChX/yl3.png "Age demographics of survey respondents"){#fig-yl-bar-age fig-alt="Bar chart showing age distriubtion of respondents. Range from 23 to 62. Approximately double the frequencies between ages 26 to 39 than outside this range, with some variation." fig-pos="H"}
...
#| label: py-yl-load
import pandas as pd
yl_p = pd.read_csv('resources/ForChX/yl53.csv')
yl_p.head()
```
...
![ROC curve illustration](resources/ForChX/roc-curve.png "ROC curve illustration"){#fig-roc-curve-cartoon fig-alt="Illustration of what a ROC curve looks like. Showing a perfect classifier is like an inverted L, a random classifier a slope 1 y=x line, with better classifier curves in between." fig-pos="H"}
...
![Brushtail Possum](resources/ForChX/Brushtail.jpg "Brushtail Possum"){fig-alt="Photo of a Common Brushtail Possum sitting in a tree.".lightbox}
...
possum <- read.table('resources/ForChX/possum.txt', header = TRUE)
...
```{r, results='hide'}
rawdata <- read.csv("resources/ForChX/hairbiomarkers.csv", header = TRUE)
